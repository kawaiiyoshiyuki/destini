...
class StoryBrain {
  ...
  void nextStory(int choiceNr) {
    switch (_storyNumber) {
      case (0):
        choiceNr == 1 ? _storyNumber = 2 : _storyNumber = 1;
        break;
      case (1):
        choiceNr == 1 ? _storyNumber = 2 : _storyNumber = 3;
        break;
      case (2):
        choiceNr == 1 ? _storyNumber = 5 : _storyNumber = 4;
        break;
      default:
        restart();
    }
...
// check if storyNumber is 0 or 1 or 2 else it should return false.
